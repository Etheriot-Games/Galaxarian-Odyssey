...
function SetClientHexaneStatus()
    ...
    elseif hexaneStatus == false then
        ...
        HEXANE_UI_TEXT_BOX.text =  "You don't own any Pathfinder NFT and won't be able to pickup weapons. Make sure you have purchased a Pathfinder NFT and connected your Metamask wallet to Core."
        HEXANE_UI_TEXT_BOX.shouldWrapText = false
        HEXANE_UI_TEXT_BOX.shouldWrapText = true
