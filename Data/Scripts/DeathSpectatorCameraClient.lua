...
local CAMERA = script:GetCustomProperty("SpectatingCamera"):WaitForObject()
...
function Tick(deltaTime)
	...
	elseif LOCAL_PLAYER.isDead then
		...
		--print("Current Cam: "..LOCAL_PLAYER:GetActiveCamera().name)
